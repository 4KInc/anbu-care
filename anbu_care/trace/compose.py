...
_WHAT = {
    ...
    "pre_auth.requested": "Cashless pre-authorisation was requested",
    "pre_auth.authorized": "The counterparty authorised cashless, provisionally",
    "pre_auth.queried": "The counterparty asked for more before authorising",
    "pre_auth.denied": "The counterparty refused cashless",
    "pre_auth.clock_breached": "The 1-hour authorisation window passed with no decision",
